...
const icons = [
  <div className="rounded-full bg-blue-300/20 p-4">
    <ReactIcon className="h-8 w-8 text-blue-400" />
  </div>,
  ...
  return (
    ...
    >
      <div
        style={{
          background: 
            "linear-gradient(100deg, rgba(200, 132, 252, 0) 20.79%, rgba(75,0,130, 0.2) 40.92%, rgba(147,112,219, 0) 80.35%)",
        }}
        className="w-full flex flex-col items-center justify-center p-8 mt-0 mb-5 "
      >
        <motion.h1
          {...{
        ...
        >
          This website was built with these modern web technologies<br />
		  <br/>
        </motion.h1>
        ...
        <p className="text-center text-sm text-zinc-400 md:text-2xl lg:text-3xl mt-5">
